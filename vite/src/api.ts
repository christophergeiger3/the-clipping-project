...
export const authControllerLogin = (
    ...
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof authControllerLogin>>, TError,{data: CreateUserDto}, TContext>, axios?: AxiosRequestConfig}
) => {
      const {mutation: mutationOptions, axios: axiosOptions} = options ?? {};
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof authControllerLogin>>, {data: CreateUserDto}> = (props) => {
          const {data} = props ?? {};

          return  authControllerLogin(data,axiosOptions)
        }

      return useMutation<Awaited<ReturnType<typeof authControllerLogin>>, TError, {data: CreateUserDto}, TContext>(mutationFn, mutationOptions)
    }
